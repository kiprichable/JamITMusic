...
class MusicPlayerController extends Controller
{
    ...
    public function welcome()
    {
        ...
        return view('Layout.home',compact('music'));
    }
    public function uploadpage()
    {
        return view('Layout.fileUpload');
    }
    public function upload()
    {
        ...
        if(Input::hasFile('file'))
        {
            ...
            echo $file;
            $file->move('Music', $file->getClientOriginalName());
    ...
    public function image(){
        return view('Layout.image');
    }
    public function create()
    {
        $file = Input::file('file');
        $stereo = Request::input('stereo');
        $file->move('Music', $file->getClientOriginalName());
    ...
    public function sound()
    {
        ...
        return view('Layout.soundPlay', compact('music'));
